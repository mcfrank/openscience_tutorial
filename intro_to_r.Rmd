...
# let's use the y vector we created above (5 to 25 by 5); what is the mean?
...
## Using tidyr
  ...
  > Tidyr is a package that has to be installed and loaded before you can use any of its functions.
...
length(unique(ps_data$item)) # number of unique items
...
```
## Using tidyr to explore and characterize the dataset
